...
import { create, deleteByIds, getRolePermission, page, setRolePermission, save, type RoleVo } from '@/modules/base/api/role'
import { page as pageMenus, type MenuVo } from '@/modules/base/api/menu'
import { extractList, extractTotal } from '@/modules/base/utils/api-data'
